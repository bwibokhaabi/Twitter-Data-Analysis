...
columns = ['created_at', 'source', 'original_text','clean_text', 'sentiment','polarity','subjectivity', 'lang', 'favorite_count', 'retweet_count', 'original_author', 'screen_count', 'followers_count','friends_count', 'hashtags', 'user_mentions', 'place', 'place_coord_boundaries']
...
class TestTweetDfExtractor(unittest.TestCase):
    ...
    #This function tests the created_time function against sample input data
    ...
    def test_find_friends_count(self):
     ...
     #This is a method to test the favorite_count method.
    def test_find_favourite_count(self):
        #expected output from favorite_count
        favorite_count=[]
        #Assrting whether the given values are similar to those in the expected class
        self.assertEqual(self.df.find_favourite_count(), [0,0,0,0,0])
     
    
 #This is a method to test the retweet_count method.
